...
const CASOS: Caso[] = [
  ...
  {
    titulo: "Borde · Con enlaces de tienda",
    nota: "«Dónde conseguirlo» sale de links_compra, no de la nota. El texto es el título que el panel leyó de la página al guardar; el segundo enlace muestra la dirección porque la tienda no respondió.",
    regalo: {
      slug: "panalera-grande",
      nombre: "Pañalera grande",
      categoriaNombre: "Paseo",
      imagenUrl: null,
      especificacion: null,
      notaPapas: "La queremos con cambiador incorporado.",
      enlaces: [
        {
          tienda: "Amazon.com: Bolsa de pañales con cambiador, bolsa de…",
          url: "https://www.amazon.com/Diaper-Backpack-Changing-Station-Travel-Friendly/dp/B0D9WHGD8C?th=1",
        },
        {
          tienda: "https://www.tiendaquenorespondio.com/producto/12345",
          url: "https://www.tiendaquenorespondio.com/producto/12345",
        },
      ],
      modo: "unico",
      reservas: [],
